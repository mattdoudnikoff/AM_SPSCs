...
M forecasted demand values for the line fit. 
F is the last and therefore future forecasted value
q interval between last 2 periods with demand
S estimate of demand volume
I estimate of intervals between demand
"""

function Croston(X,n,alpha,disp_output=false,disp_plot=false)
    q = 1
    ...
    # Show plot of data
    #bar(X, xlabel="Time(days)", ylabel="Demand", title = "Demand Forecast (Croston)", label="Historical Demand")
